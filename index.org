...
#+BEGIN_SRC R :results silent :exports none
  ...
  gsub("^\\.","",names(tn.cer))->names(tn.cer)
  gsub("\\:","",names(tn.cer))->names(tn.cer)
  names(tn.cer)[54]<-"differential.treatment"
  ##gsub("Whether\\.there\\.is\\.any\\.differential\\.treatment\\.in\\.the\\.enterprise\\.on\\.the\\.basis\\.of\\.the\\.following\\:",
...
#+caption: How much do you earn as PLI
...
#+caption: How much do you earn as PLI, Tamil Nadu
#+RESULTS: tn.pli.incentive
| If.yes.how.much.do.you.earn.as.incentive |   N |
|------------------------------------------+-----|
|                                        - |   2 |
|                                      0.1 |   1 |
...
#+CAPTION: Safety measures, Tamil Nadu
#+RESULTS: tn.Safety.measures
| Safety.measures.at.workplace.Are.safety.measures.followed |  N |
|-----------------------------------------------------------+----|
| No                                                        | 36 |
| Yes                                                       | 94 |
...
#+NAME: tn.fatal.accident.if.any
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,
             .(Safety.measures.at.workplace.Was.there.any.fatal.accident.in.the.last.1.year)]
#+end_src

#+CAPTION: Fatal accidents, Tamil Nadu
#+RESULTS: tn.fatal.accident.if.any
| Safety.measures.at.workplace.Was.there.any.fatal.accident.in.the.last.1.year |   N |
|------------------------------------------------------------------------------+-----|
| No                                                                           | 117 |
|                                                                              |   6 |
...
#+NAME: tn.Do.you.get.a.paid.weekly.off
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,
             .(Do.you.get.a.paid.weekly.off)]
  #+end_src

#+CAPTION: Paid weekly off, Tamil Nadu
#+RESULTS: tn.Do.you.get.a.paid.weekly.off
| Do.you.get.a.paid.weekly.off |  N |
|------------------------------+----|
| Yes                          | 97 |
|                              |  2 |
...
#+NAME: tn.No.of.days.of.paid.leave.per.year.Casual.Leave
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,
             .(a.No.of.days.of.paid.leave.per.year.casual.leave.)][order(a.No.of.days.of.paid.leave.per.year.casual.leave.)]
#+end_src

#+CAPTION: Paid casual leaves per year, Tamil Nadu
#+RESULTS: tn.No.of.days.of.paid.leave.per.year.Casual.Leave
| a.No.of.days.of.paid.leave.per.year.casual.leave. |  N |
|---------------------------------------------------+----|
|                                                 - |  1 |
|                                               0.0 |  1 |
|                                              10.0 |  9 |
...
#+NAME: tn.Earned.Leave
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
      tn.cer[,.N,
               .(b.No.of.days.of.paid.leave.per.year.earned.leave.)][
        order(b.No.of.days.of.paid.leave.per.year.earned.leave.)]
  #+end_src

#+CAPTION: Earned leaves, Tamil Nadu
#+RESULTS: tn.Earned.Leave
  | b.No.of.days.of.paid.leave.per.year.earned.leave. |  N |
  |---------------------------------------------------+----|
  |                                                 - |  5 |
  |                                               0.0 |  4 |
  |                                             10-12 |  1 |
...
#+NAME: tn.Medical.Leave
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
      tn.cer[,.N,
               .(c.No.of.days.of.paid.leave.per.year.medical.leave.)][
        order(c.No.of.days.of.paid.leave.per.year.medical.leave.)]
  #+end_src

  #+CAPTION: Medical leaves, Tamil Nadu
  #+RESULTS: tn.Medical.Leave
  | c.No.of.days.of.paid.leave.per.year.medical.leave. |  N |
  |----------------------------------------------------+----|
  |                                                  - |  3 |
  |                                                0.0 |  8 |
  |                                                1.0 |  1 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  ...
  #+caption: Whether you get a bonus
...
#+NAME: tn.Whether.you.get.Bonus
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(Whether.you.get.Bonus)][order(Whether.you.get.Bonus)]
  #+end_src

#+caption: Whether you get a bonus, Tamil Nadu
  #+RESULTS: tn.Whether.you.get.Bonus
  | Whether.you.get.Bonus |  N |
  |-----------------------+----|
  | No                    | 45 |
  | Yes                   | 84 |
...
#+NAME: tn.bonus.Cash.Amount.Value
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,bonus.cash:=as.numeric(b.what.is.its.value)]
  tn.cer[bonus.cash<1,bonus.cash:=NA]
  tn.cer[bonus.cash<=75000,bonus.category:="4. More than 75000"]
  tn.cer[bonus.cash<75000,bonus.category:="3. Less than 75000"]
  tn.cer[bonus.cash<50000,bonus.category:="2. Less than 50000"]
  tn.cer[bonus.cash<25000,bonus.category:="1. Less than 25000"]
  tn.cer[,.N,.(bonus.category)][
    order(bonus.category)]

  #+end_src

#+CAPTION: Value of cash bonus, Tamil Nadu
  #+RESULTS: tn.bonus.Cash.Amount.Value
  | bonus.category     |   N |
  |--------------------+-----|
  | 1. Less than 25000 |  27 |
  | 3. Less than 75000 |   2 |
  |                    | 103 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
 ...
 #+CAPTION: PF
  ...
  #+NAME: tn.PF
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(PF=Whether.you.get.PF.)]
  #+end_src

 #+CAPTION: PF, Tamil Nadu
  #+RESULTS: tn.PF
  | PF  |  N |
  |-----+----|
  | Yes | 96 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  ...
  #+NAME: tn.esi
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(ESI=Whether.you.get.ESI.)]
  #+end_src

  #+CAPTION: ESI, Tamil Nadu
  #+RESULTS: tn.esi
  | ESI |  N |
  |-----+----|
  |     | 57 |
...
#+NAME: tn.Mediclaim
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(Mediclaim=Whether.you.get.Mediclaim.)]
  #+end_src

  #+CAPTION: Mediclaim, Tamil Nadu
  #+RESULTS: tn.Mediclaim
  | Mediclaim |  N |
  |-----------+----|
  | Yes       | 41 |
  |           | 77 |
...
#+NAME: tn.Pension
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(Pension=Whether.you.get.Pension.)]
  #+end_src
...
#+NAME: tn.Gratuity
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(Gratuity=Whether.you.get.graduity.)]
  #+end_src
...
#+NAME: tn.Maternity.Leave
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[Gender=="Female",.N,.(Maternity.leave=Whether.you.get.maternity.leave.,Gender)]
  #+end_src

  #+CAPTION: Maternity leave for women workers, Tamil Nadu
  #+RESULTS: tn.Maternity.leave
  | Maternity.leave | Gender |  N |
  |-----------------+--------+----|
  | Yes             | Female |  9 |
  |                 | Female | 24 |
  | No              | Female |  2 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  ...
  #+NAME: tn.employers.are.paying.for.PF
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(Whether.the.employers.are.paying.for.PF.ESI)]
  #+end_src

  #+CAPTION: Employers contributing to PF and ESI, Tamil Nadu
  #+RESULTS: tn.employers.are.paying.for.PF
  | Whether.the.employers.are.paying.for.PF.ESI |  N |
  |---------------------------------------------+----|
  | Yes                                         | 97 |
  | No                                          | 23 |
  |                                             | 12 |
...
#+NAME: tn.Drinking.water
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Drinking",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Drinking.water=facilities)]
  #+end_src

  #+CAPTION: Drinking water
  #+RESULTS: tn.Drinking.water
  | Drinking.water |   N |
  |----------------+-----|
  | Yes            | 116 |
  |                |  16 |
...
#+NAME: tn.toilet.for.men
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Toilet for men",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Toilet.for.men=facilities)]
  #+end_src

#+caption: Toilet for men, Tamil Nadu
  #+RESULTS: tn.toilet.for.men
  | Toilet.for.men |   N |
  |----------------+-----|
  | Yes            | 114 |
  |                |  18 |
...
#+NAME: tn.toilet.for.women
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Toilet for women",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Toilet.for.women=facilities)]
  #+end_src

  #+caption: Toilet for women, Tamil Nadu
  #+RESULTS: tn.toilet.for.women
  | Toilet.for.women |   N |
  |------------------+-----|
  | Yes              | 104 |
  |                  |  28 |
...
#+NAME: tn.Medical.facilities
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Medical",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Medical.facilities=facilities)]
  #+end_src

  #+caption: Medical facilities, Tamil Nadu
  #+RESULTS: tn.Medical.facilities
  | Medical.facilities |  N |
  |--------------------+----|
  | Yes                | 82 |
  |                    | 50 |
...
#+NAME: tn.transport.facilities
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Transport",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Transport.facilities=facilities)]
  #+end_src

  #+caption: Transport facilities, Tamil Nadu
  #+RESULTS: tn.transport.facilities
  | Transport.facilities |  N |
  |----------------------+----|
  |                      | 60 |
  | Yes                  | 72 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  ...
  #+NAME: tn.canteen.facilities
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Canteen",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Canteen.facilities=facilities)]
  #+end_src

  #+RESULTS: tn.canteen.facilities
  | Canteen.facilities |  N |
  |--------------------+----|
  | Yes                | 92 |
  |                    | 40 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  ...
  #+NAME: tn.creche.facilities
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Crèche",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Creche.facilities=facilities)]
  #+end_src

  #+caption: Crèche, Tamil Nadu
  #+RESULTS: tn.creche.facilities
  | Creche.facilities |  N |
  |-------------------+----|
  |                   | 86 |
  | Yes               | 46 |
...
#+caption: Restroom
  ...
  #+NAME: tn.restroom.facilities
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Rest",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Rest.facilities=facilities)]
  #+end_src

  #+caption: Restroom, Tamil Nadu
  #+RESULTS: tn.restroom.facilities
  | Rest.facilities |  N |
  |-----------------+----|
  |                 | 85 |
  | Yes             | 47 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  ...
  #+NAME: tn.parking.facilities
  #+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,facilities:=NA]
  tn.cer[grep("Parking",Welfare.facilities.at.workplace),facilities:="Yes"]
  tn.cer[,.N,.(Parking.facilities=facilities)]
  #+end_src

  #+RESULTS: tn.parking.facilities
  | Parking.facilities |  N |
  |--------------------+----|
  | Yes                | 88 |
  |                    | 44 |
...
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  ...
  #+NAME: tn.besides.this.factory.job
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(Additional.job=Are.you.also.engaged.in.any.other.job.besides.this.factory.job)]
  #+end_src

  #+caption: If engaged in any other job, Tamil Nadu
  #+RESULTS: tn.besides.this.factory.job
  | Additional.job |   N |
  |----------------+-----|
  | No             | 107 |
  | Yes            |  14 |
...
#+NAME: tn.Discrimination
#+BEGIN_SRC R :results value :exports results :hlines :colnames yes
  tn.cer[,.N,.(differential.treatment)]
  #+end_src

  #+caption: Whether there is any differential treatment in the enterprise on the basis of permanency, Gender, Caste, Religion, Language, Local or migrant, Tamil Nadu
  #+RESULTS: tn.Discrimination
  | differential.treatment |  N |
  |------------------------+----|
  | Yes                    | 32 |
  | No                     | 73 |
  |                        | 27 |
...
+ Sexual harassment
  ...
  #+NAME: tn.sexual.harassment
  #+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(a.Has.there.been.any.case.of.sexual.harassment)]
  #+end_src

  #+CAPTION: Cases of sexual harassment, Tamil Nadu
  #+RESULTS: tn.sexual.harassment
  | a.Has.there.been.any.case.of.sexual.harassment |   N |
  |------------------------------------------------+-----|
  | No                                             | 107 |
  |                                                |  18 |
  | Yes                                            |   7 |
...
#+NAME: ICC.tn
  #+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(ICC=b.Has.there.been.any.formal.complaint.registered.against.sexual.harassment)]
  #+end_src

  #+caption: If there is an ICC, Tamil Nadu
  #+RESULTS: ICC.tn
  | ICC |   N |
  |-----+-----|
  | No  | 108 |
...
+ Union
  ...
  #+NAME: tn.Whether.Union.is.there
  #+BEGIN_SRC R :results value :exports results :hlines :colnames yes
    tn.cer[,.N,.(Union=Whether.Union.is.there)]
  #+end_src

  #+caption: If there is a union, Tamil Nadu
  #+RESULTS: tn.Whether.Union.is.there
  | Union |  N |
  |-------+----|
  | No    | 63 |
  |       |  3 |
